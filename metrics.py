# https://github.com/meituan/YOLOv6/blob/main/yolov6/utils/metrics.py
import torch
...
class ConfusionMatrix:
    ...
    def process_batch(self, detections, labels):
        ...
        iou = box_iou(
            Boxes.from_tensor(labels[:, 1:], mode="xyxy", validate_boxes=False),
            Boxes.from_tensor(detections[:, :4], mode="xyxy", validate_boxes=False))
